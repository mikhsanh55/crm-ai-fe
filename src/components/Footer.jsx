            ...
            <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
                ...
                <div className="space-y-8">
                    <a href="https://flowbite.com/" className="flex items-center space-x-3 rtl:space-x-reverse">
                        ...
                        <span className="self-center text-2xl font-semibold whitespace-nowrap text-black">ClarityCRM</span>
                    </a>
                    <p className="text-sm leading-6 text-gray-600">Making Customer Management Easier in One Place.</p>
